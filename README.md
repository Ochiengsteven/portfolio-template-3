...
- tou need a basic knowledge of Html, Css and bootstrap
...
- cd my-folder
- git clone https://github.com/Ochiengsteven/portfolio-template-3
...
- GitHub: [@Ochiengsteven]([https://github.com/rachaouldbabaali](https://github.com/Ochiengsteven))
...
Feel free to check the [issues page]([https://github.com/rachaouldbabaali/Portfolio-setup-and-mobile-first/issues](https://github.com/Ochiengsteven/portfolio-template-3/issues)).
